...
class MyCerenkov : public G4VProcess
{
...
public:
	...
	MyCerenkov(const G4String& processName = "Cerenkov", 
                            G4ProcessType type = fElectromagnetic);
	~MyCerenkov();

        MyCerenkov(const MyCerenkov &right);
...
inline 
void MyCerenkov::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
void MyCerenkov::SetMaxBetaChangePerStep(const G4double value)
{
        fMaxBetaChange = value*CLHEP::perCent;
}

inline
void MyCerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons) 
{ 
	fMaxPhotons = NumPhotons;
}

inline
void MyCerenkov::DumpPhysicsTable() const
{
...
inline
G4PhysicsTable* MyCerenkov::GetPhysicsTable() const
{
