...
class PMTwinDown : public G4VSensitiveDetector
{

public:
    PMTwinDown(G4String name);
    ~PMTwinDown();
  ...
  G4bool PMTHazFired(G4double);//Argument is Opt photon wavelength in nm.
